# Python Programming Language (Python) Trademarks Logo 1200x1200 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x1200.svg)](#)

The Python Trademarks Logo. They published clear trademark guideline and
...
This project re-draws Python Trademarks Logo specifically for 1200x1200 size.
...
Since Python published its brand and trademark guideline, **you MUST go through
all the following to avoid any unwanted legal implications**:

* https://www.python.org/community/logos

While not specified by Python, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: Python Programming Language (Python) Trademarks Logo 1200x1200
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-pythonlang-1200x1200
UUID: 11616E04-BA61-474A-90CF-7E89CDA58044
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-21
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-pythonlang-1200x1200
--------------------------------------------------------------------------------
```
...
> COMPLY WITH PYTHON PROGRAMMING LANGUAGE TRADEMARK REQUIREMENTS
> (Refer: https://www.python.org/community/logos)**.
>
